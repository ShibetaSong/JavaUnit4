...
import com.shibeta.unit4.day07.Assignment.learn.HW.View.ExceptionMessage;
...
public class ESystem {
    ...
    private final static ExpressMap eM = new ESystem().readFromFile(path);
    public Integer main() {
        mainMenu: while(true) {
            // 欢迎菜单
            Menu.welcomeMenu();
    ...
    public static ExpressMap getEM() {
        return eM;
    }
     ...
     * @return 快递类
     */
    private ExpressMap readFromFile(String path) {
        // 若路径文件不存在，则返回新的空快递信息
